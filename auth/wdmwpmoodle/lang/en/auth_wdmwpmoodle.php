...
$string['auth_wdmwpmoodle_wploginenablebtn_lbl'] = 'Enable WordPress Login';
$string['auth_wdmwpmoodle_wploginenablebtn_desc'] = 'This will enable login with WordPress button on Moodle login page.';

$string['auth_wdmwpmoodle_wploginbtntext_lbl'] = 'WordPress Login Text';
$string['auth_wdmwpmoodle_wploginbtntext_desc'] = 'This text will be shown as WordPress login button text on Moodle login page.';
