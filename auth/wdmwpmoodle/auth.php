...
class auth_plugin_wdmwpmoodle extends auth_plugin_base
{
    ...
    public function loginpage_idp_list($wantsurl) {
        ...
        // $url = $CFG->wwwroot . '/auth/wdmwpmoodle/wdmwplogin.php?' . 'wdmaction=login_with_moodle&verify_code=' . $hash . '&wpsiteurl=' . urlencode( $wpsiteurl );
        ...
        $text = ! empty($this->config->wploginbtntext) ? $this->config->wploginbtntext : get_string('WordPress', 'auth_wdmwpmoodle') ;

        $result[] = ['url' => $url, 'iconurl' => '', 'name' => $text ];
